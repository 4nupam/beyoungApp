...
const ElectronicPage = () => {
    ...
    const filteredData =()=>{
        return data.filter((e)=>(
            e.category == "electronics" && e.title.toLowerCase().includes(deb.toLowerCase())
        ))
    }
  return (
    <div className="">
    <div className="top flex p-2 items-center justify-between bg-yellow-400">
      <span className="text-lg ml-8 font-semibold font-[cursive]">Welcome to Electronic's Sections</span>
    ...
    <div className="desc p-2 ml-8 mr-8">
      <h2 className="text-2xl font-bold mb-2">Electronic's Clothing</h2>
