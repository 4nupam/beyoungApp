...
const filteredData =()=>{
    return data.filter((e)=>(
        e.category == "women's clothing" && e.title.toLowerCase().includes(deb.toLowerCase())   ))
}
    return (
        <div className="">
        <div className="top flex p-2 items-center justify-between bg-yellow-400">
          <span className="text-lg ml-8 font-semibold font-[cursive]">Welcome to Women's Sections</span>
